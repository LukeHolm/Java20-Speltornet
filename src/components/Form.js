                    ...
                    <div className="row form">
                        ...
                        Styla radio buttons, se sparad länk */}
                            ...
                            <div className="col-sm-4 offset-1">
                                ...
                                <p>Välj ett av alternativen nedanför:</p>
                                {/*TODO: onClick...fold out function */}

                                <input type="radio" id="radio" name="trade" value="otherBoardgame" />
                                <label for="otherBoardgame">Ticket to ride</label>
                                <input type="radio" id="radio" name="trade" value="otherBoardgame" />
                                <label for="otherBoardgame">Monopol</label><br></br>
                                <input type="radio" id="radio" name="trade" value="otherBoardgame" />
                                <label for="otherBoardgame">Diamanten</label>
                                <input type="radio" id="radio" name="trade" value="otherBoardgame" />
                                <label for="otherBoardgame">Game of thrones</label><br></br>
                                <input type="radio" id="radio" name="trade" value="otherBoardgame" />
                                <label for="otherBoardgame">Risk</label><br></br>
                            </div>
                        </div>
                        ...
                        <div className="form-element">
                            ...
                            <input className="thin-textarea" type="text" id="headline" placeholder="Skriv här..."
                        ...
                        <div className="form-element">
                            <h5>Kommentarer</h5>
                            <label for="comment" className="p">Beskriv skick och vilka delar som saknas. </label><br />
                            <textarea className="textarea" name="comment" rows="5" cols="30" placeholder="Skriv här...">
                            </textarea>
                        </div>
